    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function getSvgIcon(iconName) {
            const icons = {
                ...
                'android': `<svg width="24" height="24" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M2.5 2.5L4.5 5.5M12.5 2.5L10.5 5.5M4 9.5H5M10 9.5H11M1.5 12.5V10.5C1.5 7.18629 4.18629 4.5 7.5 4.5C10.8137 4.5 13.5 7.18629 13.5 10.5V12.5H1.5Z" stroke="#b3b3b3"/>`,
